...
describe CiteMakor::TweetParser do
  ...
  [
    ...
    ["@CiteMakor please CITE for me Genesis 1:1", "Genesis 1:1", details: "CAPS"],
    ...
    ["@CiteMakor something something\n\n@CiteMakor cite יהושע ו,ו\n\n/cc my friends", "יהושע ו,ו", "newline handling"],
